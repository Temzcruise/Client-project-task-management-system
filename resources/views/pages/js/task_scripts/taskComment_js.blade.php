...
function addComment() {
    ...
    let Commenthtml = `<div class="m-messenger__wrapper commguy" style="padding-right: 10px; display:flex; flex-wrap: flex; padding-left: 10px;">
                                                        <div class="m-messenger__message m-messenger__message--in">
                                                            <div class="m-messenger__message-pic">
                                                                <img alt="" src="{{ asset('metro/assets/app/media/img/users/user3.jpg') }}" class="mCS_img_loaded" />
                                                            </div>
                                                            <div class="m-messenger__message-body">
                                                                <div class="m-messenger__message-arrow"></div>
                                                                    <div class="m-messenger__message-content">
                                                                        <div class="m-messenger__message-username">
                                                                            <span class="secondary" style="margin-right:30px; color: #6f727d;"><strong>${userName}</strong></span>
                                                                            <span id="datee" style="float: right; color: #6f727d;">${formattedDate}</span>
                                                                        </div>
                                                                        <div class="m-messenger__message-text" id="comContent" style="  max-width: 450px; min-height:20px; max-height: 4000px; display: flex; flex-direction: column;">
                                                                            ${commentMade}
                                                                            <br>
                                                                        <i class="fa fa-trash" onclick="" style="display:flex; justify-content: flex-end; margin-bottom:5px;"></i>
                                                                        <i class="fa fa-reply" data-toggle="collapse" id="kkk" aria-hidden="true" data-target="#" aria-expanded="false" aria-controls="collapseReply" style="display:flex; justify-content: flex-end;"></i>

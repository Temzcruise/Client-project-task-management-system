...
@section('css')
    <style>
        ...
        .client-card{
            ...
            border-radius: 20px; margin: auto; margin-bottom: 2%;
...
@section('content')
        ...
        <div style="margin-bottom: 10px;" class="row">
            <a class="btn m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air btn-success pull-right" id="createClient" style="margin-left:auto; margin-right:8%; background-color:; color:white;" data-toggle="modal" onclick="changeFormat()" data-target="#createClientModal">
                    <span>
...
//          Function for deleting single project
     ...
     function deleteProReport(doc_id){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                let taskCard = document.getElementById('client-task-modal');
                    ...
                    <div class="client-card col-6 col-s-6" style="">
                        <div class="m-widget24">
                            ...
                            <div class="m-widget24__item" style="margin-bottom:3%">
                                ...
                                <div id="client-details" style="margin-left:3%">
                                    <p><strong>Address:</strong> ${datum.address}</p>
                                    <p><strong>Email:</strong> ${datum.email}</p>
                                    <p><strong>Contact:</strong> ${datum.phone}</p>
                                </div>
                            </div>
                                <div id="clientBtns" style="margin-left: 15px;">
        ...
        projectCard.innerHTML = projectCard.innerHTML + `<div class="modal fade" id="view_client_project${datum.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
            <div class="modal-dialog" style="max-width: 90%; min-width: 400px; max-height: 100%;"
                    role="document">
                <div class="modal-content">
                    <div class="modal-header">

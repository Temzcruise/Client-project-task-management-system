        ...
        <div class="m-portlet__body  m-portlet__body--no-padding">
            <div class="row m-row--no-padding m-row--col-separator-xl">
                <div class="col-md-12 col-lg-6 col-xl-3">
                    ...
                    <div class="m-widget24">
                        <div class="m-widget24__item">
                            <h4 class="m-widget24__title"><a href="" class="m-menu__link-text">Projects</a></h4>
                            <br>
                ...
                <div class="col-md-12 col-lg-6 col-xl-3">
                    ...
                    <div class="m-widget24">
                        <div class="m-widget24__item">
                            <h4 class="m-widget24__title"><a href="" class="m-menu__link-text">Tasks</a></h4>
                            <br>
                ...
                <div class="col-md-12 col-lg-6 col-xl-3">
                    ...
                    <div class="m-widget24">
                        <div class="m-widget24__item">
                            <h4 class="m-widget24__title"><a href="" class="m-menu__link-text">Clients</a></h4>
                            <br>
                            <span class="m-widget24__desc">Total Number</span>
